...
export function RiskGaugeCard({
    ...
    // const realPercentage = Math.round((riskScore || 0) * 100) // Keep generic reference if needed
    ...
    return (
        <motion.div
            ...
            className="h-full"
        >
            <Card variant="glass" className={cn("w-full h-full transition-all duration-500 border-teal-200/50 shadow-md backdrop-blur-xl", isLowTrust ? "bg-teal-50/40" : "bg-white/40")}>
